...
mod tests {
    ...
    fn test_ast(#[case] case: u32) {
        ...
        let output =
            std::fs::read_to_string(format!("../../tests/httpql/ast/{case}/output.ast")).unwrap();
    ...
    fn test_error(#[case] case: u32) {
        let input =
            std::fs::read_to_string(format!("../../tests/httpql/error/{case}/input.httpql"))
                .unwrap();
    ...
    fn test_regex(#[case] case: u32) {
        let input =
            std::fs::read_to_string(format!("../../tests/httpql/regex/{}/input.httpql", case))
                .unwrap();
        let test = serde_json::from_str::<Test>(
            &std::fs::read_to_string(format!("../../tests/httpql/regex/{}/test.json", case))
                .unwrap(),
        )
        .unwrap();
    ...
    fn test_string(#[case] case: u32) {
        let input =
            std::fs::read_to_string(format!("../../tests/httpql/string/{}/input.httpql", case))
                .unwrap();
        let test = serde_json::from_str::<Test>(
            &std::fs::read_to_string(format!("../../tests/httpql/string/{}/test.json", case))
                .unwrap(),
        )
        .unwrap();
