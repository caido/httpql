...
describe("deserialize", () => {
  ...
  it("should parse WSQL expression with escaped backslash", () => {
  ...
  it("should parse WSQL expression with escaped quote", () => {
  ...
  it("should parse WSQL stream expression", () => {
  ...
  it("should parse WSQL ws expression", () => {
  ...
  it("should parse WSQL AND expression", () => {
  ...
  it("should parse WSQL OR expression", () => {
  ...
  it("should parse WSQL from left to right", () => {
    const query =
  ...
  it("should parse WSQL group expression", () => {
    const query =
